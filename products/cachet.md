...
Cachet does not follow a documented release policy but generally adheres to semantic versioning, with active development focused on the latest major version. While versioning implies stability, occasional breaking changes can still appear in minor updates during ongoing development.
